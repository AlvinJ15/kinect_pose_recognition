    ...
    public partial class MainWindow : Window
    {
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (null != this.sensor)
            {
                ...
                DbServices.AddTrainingRed("first", System.Convert.ToBase64String(ReadWriteObjectFile.ObjectToByteArray(postureRecognition)), "static");
        ...
        {                        
            if(!flag)
            {
                ...
                lista = new List<Skeleton>();
            }
            else
            {
                Estado.Text = "Listo";
                File.WriteAllBytes(Parte.Text, ObjectToByteArray(lista));
            }
            flag = !flag;
            numCount = 0;
        }
        ...
        {
            int el = sensor.MaxElevationAngle;
